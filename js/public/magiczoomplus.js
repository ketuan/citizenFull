/*
   ...
   Magic Zoom Plus v4.0.30 for MagicToolbox.com
...
var MagicZoomPlus = (function (g) {
    ...
    var b = {
        version: "v2.1.0.rc24-2-g86805b3",
        options: {},
        lang: {},
        start: function (m) {
    ...
    var a = new g.Class({
        ...
        t1: function () {
            ...
            if ("undefined" !== typeof (k)) {
                ...
                var n;
                this.cr = n = g.$new(((Math.floor(Math.random() * 101) + 1) % 2) ? "span" : "div").j6({
                    display: "inline",
                    overflow: "hidden",
                    visibility: "visible",
                    color: k[1],
                    ...
                    textAlign: "right",
                    right: 8,
                    zIndex: 5 + ("" + (q.j5("z-index") || 0)).j17()
                }).changeContent(j).j32(this.t23);
                n.j6({
                    top: r.height - n.j7().height - 5
                });
                var m = $mjs(n.byTag("A")[0]);
                if (m) {
                    m.je1("click", function (u) {
                        u.stop();
                        window.open(u.getTarget().href)
                    })
                }
                delete k;
                delete j
