    ...
    protected function _prepareLayout()
    {
        ...
        if ($headBlock) {
            ...
            if ($title) {
				...
				$headBlock->setTitle('Buy '.$product->getName().' with Free Delievery | ShoeHouze');
			}
            ...
            if ($keyword) {
				...
				$headBlock->setKeywords($product->getName().', Malaysia');
            }
            ...
            if ($description) {
				...
				$headBlock->setDescription('Get '.$product->getName().' at ShoeHouze, Malaysia\'s online shoes store. Free local delivery. Read reviews.');
            }
