...
class FME_Manufacturers_Adminhtml_ManufacturersController extends Mage_Adminhtml_Controller_Action
{
	...
	public function categoriesAction()
    {
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('manufacturers/adminhtml_manufacturers_edit_tab_categories')->toHtml()
        );   
    }
    ...
    {
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('manufacturers/adminhtml_manufacturers_edit_tab_categories')
	...
	public function saveAction() {
		...
		if ($data = $this->getRequest()->getPost()) {
			...
			$_POST['new_categories_ids'] = $comma_separated;
	...
	*/
	...
	public function updateCatalogProductEntityInt($brand_id){
		...
		$productIdsString = trim($productIdsString, '0,');
		...
		/*echo " productIdsString = ".$productIdsString;
		echo " old_product_ids = ".$old_product_ids;
		echo "<pre>";print_r($_POST);print_r($Result);exit;*/
			
		//echo "DELETE FROM ".$catalog_product_entity_int." WHERE entity_id in ($productIdsString) and attribute_id = ".$attributes[0]['attribute_id'];exit;
