...
DROP TABLE IF EXISTS {$this->getTable('manufacturers_categories')};
CREATE TABLE {$this->getTable('manufacturers_categories')} (                            
`manufacturers_id` int(11) NOT NULL,                         
`category_id` smallint(5) unsigned NOT NULL,                   
PRIMARY KEY  (`manufacturers_id`,`category_id`),             
KEY `FK_CATEGORYBRANDS_CATEGORIES` (`category_id`)            
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Manufacturers Categories';
