...
class FME_Manufacturers_Block_Adminhtml_Manufacturers_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
  ...
  protected function _beforeToHtml()
  {
	  ...
	  $this->addTab('categories_section', array(
		'label'     => Mage::helper('manufacturers')->__('Apply to Categories'),
		'title'     => Mage::helper('manufacturers')->__('Apply to Categories'),
		'content'   => $this->getLayout()->createBlock('manufacturers/adminhtml_manufacturers_edit_tab_categories')->toHtml(),
	));
