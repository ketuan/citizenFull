...
class FME_Manufacturers_Block_Adminhtml_Manufacturers_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('manufacturers/cattree.phtml');
    }
