<?php
class Sm_Slickslider_Block_Adminhtml_System_Config_Form_Field_Additem extends Mage_Adminhtml_Block_System_Config_Form_Field_Regexceptions
{
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html ='<div id="slickslider_cfg_product_selection_product_additem">'.$html.'</div>';
	return $html;
    }	
}