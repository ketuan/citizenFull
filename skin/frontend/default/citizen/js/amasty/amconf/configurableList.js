...
Product.Config.prototype.selectImage = function(element)
{
    ...
    if ('-1' != pos) {
        ...
        this.settings.each(function(select){
            ...
            if (!parseInt(select.value) && 'undefined' != typeof(confData[parentId]) && confData[parentId].oneAttributeReload && "undefined" != typeof(select.options[1]))
            {
        ...
        if('undefined' != typeof(confData[parentId]) && confData[parentId]['optionProducts'][key]){ 
