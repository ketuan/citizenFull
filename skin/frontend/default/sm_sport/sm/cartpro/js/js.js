...
function addOptionscart(){
	...
	str=str+'					<div id="fancybox-wrap" style="display:none;"><div id="fancybox-outer">';
	str=str+'						<div id="confirmbox"></div>';
	str=str+'						<a id="fancybox-close" style="display: inline;" onclick="$(\'confirmbox\').innerHTML=\'\';$(\'fancybox-wrap\').setStyle({display:\'none\'});$(\'options\').setStyle({display:\'none\'});"></a>';
	str=str+'					</div></div>';
	str=str+'			</DIV>';
	str=str+'		</DIV>	';
	str=str+'	</div>';
...
function initfunc(){
	...
	//myElement="sometext";myElement.appendToTop('body');
		...
		//same f[0].insert(new Element('p')).down().update('This is myinserted paragraph');;
